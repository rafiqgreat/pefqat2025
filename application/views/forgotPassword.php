...
<html>
  <head>
    <meta charset="UTF-8">
    <title>PEC : Forgot Password</title>
  ...
  <body class="login-page" style="background: url('<?php echo base_url(); ?>assets/images/background.jpg') no-repeat center center fixed;background-size: cover;">
    <div class="login-box">
