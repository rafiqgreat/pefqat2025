                ...
                <form method="POST" action="<?= base_url('center/addNewCenter') ?>">
                    <div class="form-row">
                        <div class="form-group col-md-4 mb-3">
							...
							<?php if ($this->session->userdata('role') == 2) { ?>
							    <input type="hidden" name="school_district_id" id="school_district_id_hidden" value="<?= $this->session->userdata('district'); ?>">
							<?php } ?>
                        </div>
                        <div class="form-group col-md-4 mb-3">
                    ...
                    <div class="form-row">
                        <div id="school-details" class="mt-4" style="">
                            ...
                            <p><strong>School EMIS Code:</strong> <span id="school_id_display"></span> &nbsp; &nbsp; <strong>School Name:</strong> <span id="school_name_display"></span> &nbsp; &nbsp; <strong>School Address:</strong> <span id="school_address_display"></span>  &nbsp; &nbsp; <strong>GPS Latitude:</strong> <span id="school_gps1_display"></span>   &nbsp; &nbsp; <strong>GPS Longitude:</strong> <span id="school_gps2_display"></span></p>
                        </div>
                    </div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
						...
						const lat1 = parseFloat($('#school_gps1_display').text()) || 0;
const lon1 = parseFloat($('#school_gps2_display').text()) || 0;
const lat2 = parseFloat(value.s_lat) || 0;
const lon2 = parseFloat(value.s_long) || 0;

console.log('School_id:', value.s_id, 'lat1:', lat1, 'lon1:', lon1, 'lat2:', lat2, 'lon2:', lon2);
...
schoolOptions += `<option value="${value.s_id}">${value.username + "-" + value.s_name + "-" + distance}</option>`;
////////////////////		
