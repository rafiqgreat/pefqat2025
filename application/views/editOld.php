                    ...
                    <form role="form" action="<?php echo base_url() ?>editUser" method="post" id="editUser" role="form">
                        <div class="box-body">
							...
							<div class="row">                                
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="district">Assign District</label>
                                        <select class="form-control required" id="district" name="district">
                                            <option value="">Select District</option> 
											 <?php
                                            if(!empty($districts))
                                            {
                                                foreach ($districts as $rl)
                                                {
                                                    ?>
                                                    <option value="<?php echo $rl->district_id; ?>" <?php if($rl->district_id == $district_id) {echo "selected=selected";} ?>><?php echo $rl->district_name_en ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
