...
class User extends BaseController
{
    ...
    function userListing()
    {
        ...
        {        
			...
			//die();
            $this->global['pageTitle'] = 'PEC : User Listing';
    ...
    function addNew()
    {
        ...
        else
        {
            ...
            $data['roles'] = $this->user_model->getUserRoles();
			 ...
			 $data['districts'] = $this->user_model->getUserDistricts();
            
            $this->global['pageTitle'] = 'PEC : Add New User';
    ...
    function editOld($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'PEC : Edit User';
    ...
    function loginHistoy($userId = NULL)
    {
        ...
        else
        {
            ...
            $this->global['pageTitle'] = 'PEC : User Login History';
